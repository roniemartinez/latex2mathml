...
setup(
    ...
    install_requires=[],
    extras_require={"dev": ["autoflake==1.*,>=1.3.1", "black==21.*,>=21.5.0.b2", "codecov==2.*,>=2.0.16", "dephell==0.*,>=0.8.3", "flake8==3.*,>=3.7.9", "isort==5.*,>=5.4.2", "multidict==5.*,>=5.1.0", "mypy==0.*,>=0.812.0", "pytest==6.*,>=6.0.1", "pytest-cov==2.*,>=2.8.1", "tomlkit==0.7.0", "typing-extensions==3.*,>=3.7.4", "xmljson==0.*,>=0.2.0"]},
)
